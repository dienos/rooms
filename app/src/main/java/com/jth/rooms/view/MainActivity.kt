...
class MainActivity : BaseBindingActivity<ActivityMainBinding>() {
    ...
    private fun initCheckBox() {
        binding.checkOneRoom.setOnCheckedChangeListener(object : CompoundButton.OnCheckedChangeListener {
        ...
        binding.checkTwoRoom.setOnCheckedChangeListener(object : CompoundButton.OnCheckedChangeListener {
            override fun onCheckedChanged(buttonView: CompoundButton?, isChecked: Boolean) {
                if(isChecked) {
        ...
        binding.checkApt.setOnCheckedChangeListener(object : CompoundButton.OnCheckedChangeListener {
            override fun onCheckedChanged(buttonView: CompoundButton?, isChecked: Boolean) {
                if(isChecked) {
        ...
        binding.checkMonth.setOnCheckedChangeListener(object : CompoundButton.OnCheckedChangeListener {
            override fun onCheckedChanged(buttonView: CompoundButton?, isChecked: Boolean) {
                if(isChecked) {
        ...
        binding.checkCharter.setOnCheckedChangeListener(object : CompoundButton.OnCheckedChangeListener {
            override fun onCheckedChanged(buttonView: CompoundButton?, isChecked: Boolean) {
                if(isChecked) {
        ...
        binding.checkSell.setOnCheckedChangeListener(object : CompoundButton.OnCheckedChangeListener {
            override fun onCheckedChanged(buttonView: CompoundButton?, isChecked: Boolean) {
                if(isChecked) {
    ...
    private fun initAdapter() {
        ...
        (binding.viewModel as MainViewModel).roomPagedList
